    ...
    <div className="lg:col-span-1">
      <div className="bg-[#2A2E39] p-6 rounded-xl sticky top-24 space-y-4 border border-gold/20">
        ...
        <div className="space-y-4 text-base">
          ...
          <div className="flex justify-between font-bold text-2xl text-gold pt-2">
            ...
            <AlertDialogContent>
              <AlertDialogHeader>
                ...
                <AlertDialogDescription>
                  This action cannot be undone. This will permanently clear the current quotation form.
                </AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
